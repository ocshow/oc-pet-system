...
<svg width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const SOUPS = [
    ...
    { s: '女子每晚都在卧室里“晒太阳”，却没有任何设备发热。她的睡眠因此改善。怎么做到的？', h: '不是热量，而是光谱', a: '她使用定时全光谱/晨昏模拟灯，夜间渐暗、清晨“日出”，重置生物钟，改善睡眠质量。' },
    { s: '一位跑者在终点前突然停下，掉头跑回人群，结果成绩更好。怎么可能？', h: '赛制并非传统路跑', a: '这是越野折返赛（Out-and-back）或计时段赛，他返回补给点/计时门卡住最佳分段时间，综合成绩更优。' },
    { s: '摄影师给夜空拍照，却关掉了相机的防抖功能，照片反而更清晰。为什么？', h: '设备放置方式改变了惯常做法', a: '长曝光架在三脚架上，电子防抖会引入校正抖动，关掉后星轨/星点更清晰。' },
    { s: '城市发生短时全城停电，但医院里的新生儿没有任何风险，反而减少了干扰。为什么？', h: '有一套比市电更可靠的系统', a: '医院有独立UPS/发电与NICU冗余系统，停电使非必要设备静默，环境更安静，护理更专注。' },
    { s: '作家在书未出版前就公开了“最后一章”，却没有剧透。读者仍热烈讨论。为什么？', h: '“最后一章”的含义变了', a: '他公开的是附录/注释式“终章”，是创作方法、引用与致谢，不包含剧情。' },
    { s: '潜水员在水下与队友分开，却能靠“看不见的地图”准确汇合。如何做到？', h: '不是电子设备', a: '借助水流、地形“等深线”与时间-气量规划（Rule of thirds），通过气泡方向与沉积物扰动判断位置。' },
    { s: '一位棋手在对局中没有任何着法被记录，却被判负。为什么？', h: '规则层面的判定', a: '他超时或触犯“手机响即负”等规则；对局合法但未留棋谱并不影响判负。' },
    { s: '航班落地后，乘客自发鼓掌，但机组神情凝重。后来证实这次降落是一次成功的“失败”。为什么？', h: '程序化决策', a: '原本尝试复飞因条件突变改为备降，计划失败但风险控制成功，称为“成功的失败”。' },
    { s: '画家花了三天画一条“看不见的河”，展览当天很多人说“听见了水声”。为什么？', h: '多感官暗示', a: '他绘制了光影与倒影，并在展厅用环境声场与气味装置营造沉浸感。' },
    { s: '一位程序员修复了线上事故，回到家什么也没做，第二天问题自行出现又自行消失。为什么？', h: '边界条件与传播延迟', a: 'CDN缓存/配置在TTL后传播生效与回滚，问题的出现与消失是延迟与失效共同作用。' },
    { s: '登山者在山顶丢失手套，只剩一只，却让另一队人获救。怎么回事？', h: '“丢”是刻意的', a: '他把一只丢下山脊作信号标记/挡风物，另一队据此判断风向与安全通道。' },
    { s: '科学家宣布“我们证明了不存在的东西存在过”。公众以为悖论。其实并不。为什么？', h: '科学语言的习惯', a: '他们通过缺失模式（负结果）证明了某粒子/事件在早期宇宙存在过的统计痕迹。' },
    { s: '小提琴家在舞台上拉断了一根弦，却没有停，观众却更激动。为什么？', h: '演奏策略改变', a: '用三弦重新编配指法与和声，展现高超应变，被视作更精彩的现场。' },
    { s: '古董商买下一只“破表”，却说它每天都准确两次，但真正有价值的不是这个。那是什么？', h: '观察表壳以外', a: '真正有价值的是表带/铭刻/来源证明（Provenance），两次准点只是笑谈。' },
    { s: '研究员把失败实验写成了最被引用的论文。为什么？', h: '可复现的“失败”', a: '他们系统性证明某条路径不可行，节省了同行大量资源，因此高被引。' },
    { s: '一位盲人“看见”了日出。没人说谎。怎么做到？', h: '感官并不只有视觉', a: '通过温度、气味、环境声以及伴随者的触觉描述/触觉画板，他在自己的感官范畴“看见”了日出。' }
  ];
  let soupIndex = 0;
  function initSoup() {
